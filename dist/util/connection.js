...
var CascadeConnection = /*#__PURE__*/function (_BaseConnection) {
  ...
  function CascadeConnection(parent, inherits) {
    ...
    if (error) parent.on('error', _this2.onError.bind(_assertThisInitialized(_this2)));
    if (close) parent.on('close', _this2.onClose.bind(_assertThisInitialized(_this2)));
    if (open) parent.on('open', _this2.onOpen.bind(_assertThisInitialized(_this2)));
